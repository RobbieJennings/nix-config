...

{
  options = {
    plasma-manager.enable =
      lib.mkEnableOption "enables plasma-manager customisations";
  };
        ...
        widgets = [
          ...
          "org.kde.plasma.pager"
          {
            iconTasks = {
              ...
              ] ++ (if config.web.brave.enable then
          ...
          }
          {
            systemMonitor = {
              ...
              totalSensors =
                [ "memory/physical/userPercent" "memory/swap/usedPercent" ];
            };
          }
          {
            systemMonitor = {
